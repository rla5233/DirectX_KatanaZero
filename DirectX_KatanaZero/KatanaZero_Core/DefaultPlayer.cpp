...
void ADefaultPlayer::CreateAnimation()
{
	...
	GetRenderer()->CreateAnimation(Anim::player_postcrouch, ImgRes::player_postcrouch, 0.08f, false);
	GetRenderer()->CreateAnimation(Anim::player_precrouch, ImgRes::player_precrouch, 0.08f, false);
